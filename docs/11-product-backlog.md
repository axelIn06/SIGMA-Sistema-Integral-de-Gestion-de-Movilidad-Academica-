...
| US-03 | Catálogos      | Como administrador, quiero administrar periodos, universidades, facultades y escuelas. | P1        | S2/S8           | **Parcial:** catálogo oficial de facultades y escuelas UNSAAC disponible y validado en la postulación.       |
...
| US-07 | SGMS           | Como estudiante UNSAAC, quiero completar mi perfil académico.                          | P0        | S3              | **Hecho localmente:** código derivado del correo y selección relacionada de facultad y escuela profesional.  |
| US-08 | SGMS           | Como estudiante UNSAAC, quiero crear un borrador de postulación saliente.              | P0        | S3              | **Hecho localmente:** formulario único de documentos, borrador privado y continuación posterior.             |
| US-09 | SGMS           | Como estudiante UNSAAC, quiero enviar mi postulación al completar requisitos.          | P0        | S3              | **Hecho localmente:** bloquea el envío sin foto, datos académicos válidos o documentos obligatorios.         |
