...
| US-06 | Consulta | Como estudiante, quiero ver convocatorias activas y sus requisitos. | P0 | S2 | Solo se muestran convocatorias publicadas y vigentes. |
| US-07 | SGMS | Como estudiante UNSAAC, quiero completar mi perfil académico. | P0 | S3 | Datos requeridos validados y editables solo por su propietario. |
| US-08 | SGMS | Como estudiante UNSAAC, quiero crear un borrador de postulación saliente. | P0 | S3 | Puede guardar y continuar sin enviar el expediente. |
